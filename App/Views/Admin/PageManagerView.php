...
<form name="main_form" method="post">
    <div class="container bot-shadow">
        <input id="all-check" onclick="pg_all_check_click();" style="margin-left: 13px;" type="checkbox" />
    ...
    <div class="container box-scrolling">
        ...
        <div name="page" class="page">     
                <div class="page-col">
                    <input id="page-check<?php echo $index; ?>" onchange="pg_page_check_onchange();" name="page-select_<?php echo $Page->getValue()->PageId; ?>" type="checkbox" />
